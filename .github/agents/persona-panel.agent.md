...
agents: [gov-researcher, party-advisor]
---
...
스킬 의존: [review-persona](../../.agents/skills/review-persona/SKILL.md)
...
- 외부 공식 자료 보강이 필요하면 `gov-researcher`에 위임한다.

## 위임 기준

- 강령·당헌·당규 정합성 검토 → `party-advisor`
- 원문 사실관계 보강·공식 출처 확인 → `gov-researcher`
